using DeviceTuner.Modules.ModuleName.ViewModels;
using DeviceTuner.Services.Interfaces;
using Moq;
using Prism.Regions;
using Xunit;

namespace DeviceTuner.Modules.ModuleName.Tests.ViewModels
{
    public class ViewSwitchViewModelFixture
    {
        ...
        public ViewSwitchViewModelFixture()
        {
        ...
        {
            var vm = new ViewSwitchViewModel(_regionManagerMock.Object, _messageServiceMock.Object);
